...
import { getStringListFromContext, normalizeText, normalizeTextArray } from "../helpers/util"
...
export function bargeInFields(condition: TNodeFieldCondition): Array<INodeField> {
    return [
        {
            type: "toggle",
            key: "bargeInOnSpeech",
