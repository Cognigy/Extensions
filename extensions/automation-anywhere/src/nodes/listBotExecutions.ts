...
export interface IListBotExecutionsParams extends INodeFunctionBaseParams {
	config: {
		connection: {
			url: string;
			username: string;
...
export const listBotExecutionsNode = createNodeDescriptor({
	type: "listBotExecutions",
	defaultLabel: "List Bot Executions",
	fields: [
		{
			key: "connection",
	...
	function: async ({ cognigy, config }: IListBotExecutionsParams) => {
