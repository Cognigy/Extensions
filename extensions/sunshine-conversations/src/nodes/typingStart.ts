...
export interface ITypingStartParams extends INodeFunctionBaseParams {
	config: {
		connection: {
			keyId: string;
			secret: string;
...
export const typingStartNode = createNodeDescriptor({
	type: "typingStart",
	...
	function: async ({ cognigy, config }: ITypingStartParams) => {
