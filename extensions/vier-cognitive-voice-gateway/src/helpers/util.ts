...
export function normalizeTextArray(
    texts: Array<string | undefined> | string | undefined | null,
...
export function convertDurationFromSecondsToMillis(
...
export function normalizeData(
    ...
    dataObject: object | undefined | null,
): Data | undefined {
    if (!dataObject) {
        return undefined
    }
...
export function normalizeSipHeaders(
    headersObject: object | undefined,
): CustomSipHeaders | undefined {
    if (!headersObject) {
        return undefined
    }
...
export function normalizeUserToUserInformation(
    userToUserInformation: Array<string> | undefined,
): Array<string> | undefined {
...
export function normalizeInteger(
    numeric: number | string | undefined | null,
