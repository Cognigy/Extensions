...
This service uses the Chuck Norris API for jokes. **We do not filter or moderate the content returned by the Chuck Norris API.** As a result, jokes may contain language or themes that are unexpected or inappropriate. Use at your own discretion.